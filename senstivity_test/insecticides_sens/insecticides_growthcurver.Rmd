...
aucl_formatting_function <- function(growthcurver_data) {
  ...
  # set correct concentration
  controls_alone$concentration <- 0
...
```{r}
line_plot_function <- function(assigned_controls_df) {
...
line_plot_list <- line_plot_function(assigned_controls_df)
```
