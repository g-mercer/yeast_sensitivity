...
Residuals don't have constant variance and shapiro test fails (not normally distributed). Look at the distribution of the model residuals to visually identify potential transformation. Data is negatively skewed. A reflection and log transformation might make the model residuals normally distributed. 

```{r}
density <- density(insect_conc_day_model_metrics$.resid)
...
# construct model with transformed data
...
trans_density <- density(trans_insect_conc_day_model_metrics$.resid)
