...
```{r}
chlor <- model_df_anomalies_removed [grep(pattern = "chlorpyrifos", x = model_df_anomalies_removed$insecticide), ]
chlor_1 <- chlor [grep(pattern = "^1$", x = chlor$concentration), ]
mean(chlor_1$auc_l)
