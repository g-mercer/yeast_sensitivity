...
# setwd
cd /Users/guymercer/projects/yeast_sensitivity/senstivity_test/2_strain/
...
# plots
 pdf(file = "./example_growth_curves.pdf",   # The directory you want to save the file in
...
# plots
 pdf(file = "./pdr.pdf",   # The directory you want to save the file in
     width = 6, # The width of the plot in inches
     height = 4) # The height of the plot in inches
...
pdr_plot
 ...
 pdf(file = "./by.pdf",   # The directory you want to save the file in
     width = 6, # The width of the plot in inches
     height = 4) # The height of the plot in inches
...
write.csv(p_by_table, "./p_by_table.csv", row.names = TRUE)

p_pdr_table <- p_pdr [1:10,]

write.csv(p_pdr_table, "./p_pdr_table.csv", row.names = TRUE)
