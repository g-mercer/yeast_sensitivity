...
factor_levels <- c("acet-high", "acet-high-salt", "acet-low", "acet-low-salt", "control", "control-salt",
                   "thia-high", "thia-low", "thia-low-salt")
...
aucl_treatment_model <- lm(auc_l ~ treatment, data = sample_aucl)
