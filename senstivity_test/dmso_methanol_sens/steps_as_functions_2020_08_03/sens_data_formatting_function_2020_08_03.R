...
# set wd
setwd("~/Documents/phd/DEG_yeast_insecticide_expt/senstivity_test/dmso_methanol_sens/results_2020_07_15/")
# read csv
input <- read.csv(file = "./dmso_meth_formatted.csv", header = FALSE, stringsAsFactors = FALSE)
...
sens_data_corr <- sens_data_form(input)
