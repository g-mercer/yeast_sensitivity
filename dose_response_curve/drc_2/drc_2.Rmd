...
# setwd
cd /Users/guymercer/projects/yeast_sensitivity/dose_response_curve/drc_2/
...
cairo_pdf(file = "./drc.pdf",   # The directory you want to save the file in
...
write.csv(complete_summary_ll4, "./complete_summary_ll4.csv", row.names = TRUE)
```
