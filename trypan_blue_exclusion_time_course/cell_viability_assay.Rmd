...
cairo_pdf(file = "./timecourse.pdf",   # The directory you want to save the file in
...
write.csv(NVPs, "./proportions.csv", row.names = TRUE)
...
write.csv(complete_fisher_df, "./fisher_pairwise_comps.csv", row.names = FALSE)
```
